...
- [FIX] Display the storage location as a readable label (e.g. "Database")
...
- [FIX] Fix crash in the results list when all columns are deselected
- [FIX] Migrate finisher registration from deprecated TypoScript yamlConfigurations to auto-discovery
- [FIX] Migrate shortcut button creation to DocHeaderComponent::setShortcutContext()
- [FIX] Declare providesPackages metadata and remove empty ext_tables.php to silence TYPO3 v14 deprecations
...
- [TASK] Replace panel wrapper with heading on deleted-forms table
- [TASK] Extract duplicated database-storage identifier check into a utility
